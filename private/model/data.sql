...
(   '3',     '200',   'theme',        'base',         'index',        '',        'start framework', '0', ''),
(   '4',     '300',   'plugin',       'test',         'toto',         '',        'start framework', '0', ''),
(   '5',     '1000',  'controller',   'framework',    'traiterForm',  '',        'start framework', '0', ''),
(   '6',     '2000',  'view',         'framework',    'afficherPage', '',        'start framework', '0', ''),
(   '7',     '10000', 'end',          'framework',    'endCMS',       '',        'end framework', '0', '')
;
